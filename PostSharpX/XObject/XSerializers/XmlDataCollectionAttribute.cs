...
namespace XJK.XSerializers
{
    ...
    [PSerializable]
    public class XmlDataCollectionAttribute : InstanceLevelAspect, IXmlSerializable, IXmlParseData
    {
        [XmlIgnore]
        ...
        public void ReadXml(XmlReader reader)
        {
            ...
            SerializationHelper.WritDataCollection(Instance, root.Elements(), stringBuilder);
